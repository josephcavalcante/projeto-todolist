...
public class ToDoList {
    ...
    // Login e Usuário
    public boolean login(String email, String senha) { return usuarioService.login(email, senha); }
    public boolean cadastrarUsuario(String nome, String email, String senha) { return usuarioService.cadastrar(nome, email, senha); }
    public void logout() { usuarioService.logout(); }
    public boolean isUsuarioLogado() { return usuarioService.isLogado(); }
    public Usuario obterUsuario() { return usuarioService.obterUsuario(); }
    public void setNomeUsuario(String novoNome) { usuarioService.alterarNome(novoNome); }
    ...
    // LISTAR: Agora filtra pelo usuário logado!
    public List<Tarefa> listarTodasTarefas() {
        Usuario usuario = usuarioService.obterUsuario();
        if (usuario != null) {
            // CORREÇÃO: Chama o service, que deve retornar a lista da memória do objeto
            return serviceTarefas.listarPorUsuario(usuario);
        }
    ...
    public List<Tarefa> listarTarefasPorData(LocalDate data) {
        Usuario usuario = usuarioService.obterUsuario();
        if (usuario != null) {
            return serviceTarefas.listarPorDataEUsuario(data, usuario);
        }
        return Collections.emptyList();
    }
    ...
    public List<Tarefa> listarTarefasCriticas() {
        Usuario usuario = usuarioService.obterUsuario();
        if (usuario != null) {
            return serviceTarefas.listarCriticasPorUsuario(usuario);
        }
        return Collections.emptyList();
    }
    ...
    public ITarefaService getTarefaService() { return serviceTarefas; }
    ...
    public ISubtarefaService obterSubtarefaService() { return serviceSubs; }
