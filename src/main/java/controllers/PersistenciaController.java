 ...
 * @since 2.0
 */
public class PersistenciaController implements IPersistenciaController {
    private IPersistencia persistencia;
    
    /**
     * Construtor que injeta a dependência de persistência.
     * 
     * @param persistencia implementação de persistência
     */
    public PersistenciaController(IPersistencia persistencia) {
